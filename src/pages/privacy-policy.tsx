  ...
  return (
    <Box px={4} py={16} mx="auto">
      ...
      >
        ...
        <chakra.p py={2}>
          Reticulo Sport Techonology does not share personal information of any kind with
          anyone. We will not sell or rent your name or personal information to
          any third party.
        </chakra.p>

        <chakra.p py={2}>
          We do not sell, rent or provide outside access to our mailing list or
          any data we store. Any data that a user stores via our website is
        ...
        <chakra.p py={2}>
          Reticulo Sport Techonology only collects such personal information that is
        ...
        <chakra.p py={2}>
          Reticulo Sport Techonology may release personal information if Reticulo Sport Techonology is
          ...
          does identify certain criteria about our Site's users in general (such
          as we may inform third parties about the number of registered users,
