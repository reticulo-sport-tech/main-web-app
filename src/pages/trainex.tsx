...
const TrainEx = () => {
  return (
    <SEOWrapper
      title="Reticulo | TrainEx"
      description="These equipments have sensors that track your performance in training to give useful insights about fitness levels and efforts put in training."
    >
      <Product
        name={"TrainEx"}
        icon={
