...
import GooglePlayButton from "@/components/mobile-app-button/components/GooglePlayButton";
import AppStoreButton from "@/components/mobile-app-button/components/AppStoreButton";
                  ...
                  {[
                    {
                      ...
                      title: "Tournaments",
                      desc: "Discover and track tournaments with updates.",
                    },
                    {
                      icon: IoBookOutline,
                      title: "Digital Diary",
                      desc: "Record activities and monitor progress.",
                    },
                    {
                      icon: IoCardOutline,
                      title: "Fees",
                      desc: "Pay via UPI, NetBanking, Cards, EMI and more.",
                    },
                    {
                      icon: IoCalendarOutline,
                      title: "Attendance",
                      desc: "See detailed attendance and history.",
                    },
                    {
                      icon: IoMegaphoneOutline,
                      title: "Notice Board",
                      desc: "Instant updates and holiday notices.",
                    },
                  ...
                  {[
                    {
                      ...
                      desc: "Collect and manage player fees efficiently.",
                    },
                    {
                      icon: IoCalendarOutline,
                      title: "Attendance",
                      desc: "Manage attendance with detailed reports.",
                    },
                    {
                      icon: IoStatsChartOutline,
                      title: "Finances",
                      desc: "Dashboard view of academy finances.",
                    },
                    {
                      icon: IoClipboardOutline,
                      title: "Notice Board",
                      desc: "Communicate updates and holidays clearly.",
                    },
                    {
                      icon: IoPeopleOutline,
                      title: "Roster & Groups",
                      desc: "Organize players, batches and schedules.",
                    },
                  ].map(({ icon: Icon, title, desc }) => (
                    <div
                      key={title}
