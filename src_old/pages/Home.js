...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reticulo - Revolutionary Sports Technology Solutions</title>
        <meta name="description" content="Reticulo provides innovative sports technology solutions including academy management, AI analysis, and event management. Empowering athletes and coaches worldwide." />
        <meta name="keywords" content="sports technology, academy management, AI sports analysis, event management, athlete performance, coaching tools" />
        <meta property="og:title" content="Reticulo - Revolutionary Sports Technology Solutions" />
        <meta property="og:description" content="Empowering athletes and coaches with cutting-edge technology solutions for sports excellence." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://reticulo.in" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1496055828681-8d699424c1c7" />
        <link rel="canonical" href="https://reticulo.in" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Organization",
            "name": "Reticulo",
            "description": "Revolutionary sports technology solutions",
            "url": "https://reticulo.in",
            "logo": "https://reticulo.in/logo.png",
            "contactPoint": {
              "@type": "ContactPoint",
              "contactType": "Customer Service",
              "url": "https://reticulo.in/contact"
            }
          })}
        </script>
      </Helmet>
