...
const About = () => {
  ...
  const milestones = [
    {
      year: '2021',
      title: 'Small Idea with huge potential',
      description: 'Introduced Studio AI for advanced racket sports analytics.'
    },
    {
      year: '2022',
      title: 'Expanding to other sports',
      description: 'Expanded to serve all racket games.'
    },
    {
      year: '2023',
      title: 'Exploring Sports based Apps',
      description: 'Pilot projects - Whiteboard, Baddyboard and Tennisboard'
    },
    {
      year: '2024',
      title: 'Understanding the Sporting Ecosystem',
      description: 'Introduction of Mentoring, Expert Analysis and more.'
    },
    {
      year: '2025',
      title: 'Building the Future with Radlo and Eventlo',
      description: 'Launching Radlo with payments and Eventlo for comprehensive sports event management.'
    }
  ];
